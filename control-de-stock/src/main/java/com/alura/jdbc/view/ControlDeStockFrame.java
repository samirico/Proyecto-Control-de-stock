...
public class ControlDeStockFrame extends JFrame {
    ...
    private void configurarTablaDeContenido(Container container) {
        ...
        //agregamos tambien la columna cantidad
    ...
    private void configurarCamposDelFormulario(Container container) {
        ...
        //comboCategoria.addItem("Elige una Categoría"); esto antes era de object por eso permitia mandar String
        //como lo cambiamos a Categoria, ahora addItem creara una nueva instancia de Categoria recibiendo id y nombre
        comboCategoria.addItem(new Categoria (0, "Elige una Categoría")); //revisar la clase CategoriaController
    ...
    private void modificar() {
        ...
        Optional.ofNullable(modelo.getValueAt(tabla.getSelectedRow(), tabla.getSelectedColumn()))
                .ifPresentOrElse(fila -> {
                	...
                	/*var producto = new Producto(modelo.getValueAt(tabla.getSelectedRow(), 0),
                    ...
                    JOptionPane.showMessageDialog(this, String.format("item modificado con Ã©xito!"));
                }, () -> JOptionPane.showMessageDialog(this, "Por favor, elije un item"));
    }
    ...
    private void eliminar() {
        ...
        Optional.ofNullable(modelo.getValueAt(tabla.getSelectedRow(), tabla.getSelectedColumn()))
                .ifPresentOrElse(fila -> {
                	//Esto da un error de casteo, asi que primero arreglamos eso, realizando de forma correcta el casting
                    //Integer id = (Integer) modelo.getValueAt(tabla.getSelectedRow(), 0);
                	Integer id = Integer.valueOf(modelo.getValueAt(tabla.getSelectedRow(), 0).toString());
                	//getValueAt recibe un argumento de tipo string y modelo es object por lo tanto usamos toString

                	//Para llevar un conteo y saber que id ha sido eliminado
                	int cantidadEliminada;
                	
                    try {
                    	//almacenamos el numero del id que se elimina
                    ...
                    //lo mostramos en un JOptionPane
    ...
    private void guardar() {
        ...
        //Como hemos creado una clase para producto, podemos mandar datos directamente sin necesidad de hashmap(lista)
        ...
        //****try {
        	//implementaremos codigo en el metodo guardar
